  ...
  <div>
    <q-card>
      ...
      <q-card-section>
            ...
            <div class="flex q-gutter-md" >
              <q-input style="max-width: 18vw;" filled v-model="birthDate" label="Data de nascimento" mask="date"
                  :rules="['date']">
                ...
                <q-input filled v-model="filingDate" label="Data Egresso" mask="date"
                  :rules="['date']">
                  <template v-slot:append>
                    <q-icon name="event" class="cursor-pointer">
                      <q-popup-proxy cover transition-show="scale" transition-hide="scale">
